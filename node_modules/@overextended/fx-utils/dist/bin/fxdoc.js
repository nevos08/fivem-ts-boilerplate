...
function getFunctionSignature(functionArg) {
    ...
    if (ts.isIdentifier(functionArg)) {
        ...
        if (!symbol)
            return;
        return (getFunctionDeclarationFromSymbol(symbol) || getFunctionDeclarationFromSymbol(typeChecker.getAliasedSymbol(symbol)));
    }
}
/**
